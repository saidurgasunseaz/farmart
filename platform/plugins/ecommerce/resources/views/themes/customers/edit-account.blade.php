                    ...
                    <div class="bb-customer-card-header">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-muted small mb-0">
                                    {{ __('Permanently delete your account and all associated data.') }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="bb-customer-card-body">
                        ...
                        <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal"
                            data-bs-target="#delete-account-modal" data-toggle="modal" data-target="#delete-account-modal">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body pt-3">
                                ...
                                <x-core::form :url="route('customer.delete-account.store')" method="post">
                                    <div class="mb-3">
                                        <label for="password"
                                            class="form-label fw-semibold">{{ __('Confirm your password') }}</label>
                                        <input type="password" id="password" name="password" class="form-control"
                                            placeholder="{{ __('Enter your current password') }}" required>
                                    </div>
                                    <div class="mb-4">
                                        <label for="reason"
                                            class="form-label fw-semibold">{{ __('Reason (optional)') }}</label>
                                        <textarea id="reason" name="reason" class="form-control" rows="3"
                                            placeholder="{{ __('Tell us why you want to delete your account...') }}"></textarea>
                                    </div>
