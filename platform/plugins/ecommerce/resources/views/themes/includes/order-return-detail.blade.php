 <div class="col-lg-12 wow fadeInRight" style="background-color: #fff;">
@if ($orderReturn)
    <div class="customer-order-detail">
        <!-- Return Request Information Card -->
        <div class="bb-customer-card order-return-detail-card mb-4 p-3">
        ...
        <div class="bb-customer-card order-return-items-card">
            <div class="bb-customer-card-header">
                <h4 class="bb-customer-card-title h5 mb-2">
                                    ...
                                    <div class="flex-shrink-0">
                                        <div class="return-item-image">
                                            <img
                                                ...
                                                alt="{{ $item->product_name }}" style="width:60px 60px !important;"
