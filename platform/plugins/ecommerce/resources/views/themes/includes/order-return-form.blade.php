...
<div class="customer-order-detail">
    ...
    <div class="bb-customer-card order-info-card mb-4">
        <div class="bb-customer-card-header">
            <h3 class="bb-customer-card-title h5 mb-4 mt-4">
    ...
    <div class="bb-customer-card return-form-card">
        <div class="bb-customer-card-header">
            <h3 class="bb-customer-card-title h5 mb-4">
                <x-core::icon name="ti ti-package-export" class="me-2" />
                {{ __('Return Request Form') }}
            </h3>
        </div>

        <div class="bb-customer-card-body " style="margin-bottom: 40px;">
                                    ...
                                    <div class="flex-shrink-0">
                                        <div class="return-product-image">
                                            <img
                                                ...
                                                alt="{{ $orderProduct->product_name }}" style="width:50px !important;"
