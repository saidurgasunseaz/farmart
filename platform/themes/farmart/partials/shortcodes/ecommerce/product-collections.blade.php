    ...
    <div class="video-one">
        <div class="inner-container">
            <div class="video-box expand-section">
                <video id="scrollVideo" muted playsinline preload="auto" loop style="height:80%;">
...
<?php
$reviewcount = DB::table('ec_reviews')->count();
?>
@if($reviewcount > 0)
<section class="testimonial-one">
    <div class="about-one_bg-layer overlay-layer" style="background-image:url('{{asset('assets/images/background/map.png')}}')"></div>
            ...
            <div class="testimonial-one_title-column col-lg-4 col-md-12 col-sm-12">
                <div class="testimonial-one_title-outer">
                    ...
                    <div class="testimonial-one_button">
                        <a href="{{ url('about-us') }}" class="theme-btn btn-style-one">
                            <span class="btn-wrap">
                                                    ...
                                                    <div class="testimonial-block_one-author">
                                                      @if ($customer && $customer->avatar)
                                                            <img src="{{ asset('storage/' . $customer->avatar ?? '') }}"
                                                                alt="" style="width: 100px !important;" />
                                                        @else
                                                            <img src="{{ asset('asset/Unknown_person.jpg') }}"
                                                                alt="" style="width: 100px !important;" />
                                                        @endif
                                                    </div>
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="client-image">
                        <a href="#"><img src="{{asset('assets/images/clients/slider_1.jpg')}}" alt="" /></a>
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="client-image">
                        <a href="#"><img src="{{asset('assets/images/clients/slider_2.jpg')}}" alt="" /></a>
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="client-image">
                        <a href="#"><img src="{{asset('assets/images/clients/slider_3.jpg')}}" alt="" /></a>
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="client-image">
                        <a href="#"><img src="{{asset('assets/images/clients/slider_4.jpg')}}" alt="" /></a>
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="client-image">
                        <a href="#"><img src="{{asset('assets/images/clients/slider_5.jpg')}}" alt="" /></a>
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="client-image">
                        <a href="#"><img src="{{asset('assets/images/clients/slider_6.jpg')}}" alt="" /></a>
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="client-image">
                        <a href="#"><img src="{{asset('assets/images/clients/slider_7.jpg')}}" alt="" /></a>
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="client-image">
                        <a href="#"><img src="{{asset('assets/images/clients/slider_8.jpg')}}" alt="" /></a>
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="client-image">
                        <a href="#"><img src="{{asset('assets/images/clients/slider_9.jpg')}}" alt="" /></a>
                    </div>
                </div>
            ...
            <div class="faq-one_image-column col-lg-6 col-md-12 col-sm-12">
                <div class="faq-one_image-outer">
                    <div class="faq-one_image wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <img src="{{asset('assets/images/resource/faq_1.png')}}" alt="FAQ Image">
                    </div>
                    <div class="faq-one_phone">
                        <span class="icon flaticon-phone-call"></span>
                        Call any time <br>
                        <a href="tel:+919626588881">+91 909-070-7085</a>
                    </div>
                </div>
            </div>
            <?php
            $faqs = DB::table('faqs')->latest('id')->take(4)->get();
            ?>
