    ...
    <div class="section-content section-content__slider lazyload"
      ...
      <img src="assets/images/resource/about-1.jpg" alt="" />
            ...
            <section class="slider-one">
                <div class="slider-one_leaf" style="background-image:url(assets/images/main-slider/leaf.png)"></div>
                <div class="main-slider swiper-container">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="slider-one_image-layer"
                                style="background-image:url(assets/images/main-slider/banner2.jpg)"></div>
                            <div class="slider-one_pattern"
                                style="background-image:url(assets/images/main-slider/pattern-1.png)"></div>
                                    ...
                                    <div class="slider-one_content-inner">
                                        ...
                                        <div class="slider-one_button d-flex align-items-center flex-wrap">
                                            ...
                                            <div class="slider-one_video">
                                                <a href="" class="lightbox-video play-box"><span
                        ...
                        <div class="swiper-slide">
                            <div class="slider-one_image-layer"
                                style="background-image:url(assets/images/main-slider/banner1.png)">
                            </div>
                            <div class="auto-container">
                                <div class="slider-one_content  d-flex justify-content-end">
                                    <div class="slider-one_content-inner">
                ...
                <div class="slider-one_options">
                    <div class="button">
                        <a class="service-btn" href="#">More Services <i class="fa-arrow-right"></i></a>
                    </div>
                    <div class="slider-one_authors">
                        <ul>
                            <li><img src="assets/images/main-slider/author-1.jpg" alt="" /></li>
                            <li><img src="assets/images/main-slider/author-2.jpg" alt="" /></li>
                            <li><img src="assets/images/main-slider/author-3.jpg" alt="" /></li>
                            <li><img src="assets/images/main-slider/author-4.jpg" alt="" /></li>
                        </ul>
                        <div class="slider-one_reviews">
                            25k+ <br> <span>Happy Customers</span>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="service-block_one col-lg-4 col-md-6 col-sm-12">
                            <div class="service-block_one-inner wow fadeInLeft" data-wow-delay="0ms"
                                ...
                                <div class="service-block_one-image">
                                    <img src="assets/images/resource/service_1.png" alt="" />
                        ...
                        <div class="service-block_one col-lg-4 col-md-6 col-sm-12">
                            <div class="service-block_one-inner wow fadeInUp" data-wow-delay="0ms"
                                ...
                                <div class="service-block_one-image">
                                    <img src="assets/images/resource/service_2.jpg" alt="" />
                                    <div class="service-block_one-overlay overlay-layer">
                                        <div class="service-block_one-icon">
                        ...
                        <div class="service-block_one col-lg-4 col-md-6 col-sm-12">
                            <div class="service-block_one-inner wow fadeInRight" data-wow-delay="0ms"
                                ...
                                <div class="service-block_one-image">
                                    <img src="assets/images/resource/service_3.jpg" alt="" />
                                    <div class="service-block_one-overlay overlay-layer">
                                        <div class="service-block_one-icon">
        ...
        <section class="about-one">
            <div class="about-one_bg-layer overlay-layer"
                style="background-image:url(assets/images/background/about-one_pattern.png)"></div>
            <div class="auto-container">
                <div class="row clearfix">
                    ...
                    <div class="about-one_image-column col-lg-6 col-md-12 col-sm-12">
                        <div class="about-one_image-outer">
                            <div class="about-one_pattern-layer"
                                style="background-image:url('assets/images/back_move_1.jpg');"></div>
                            <div class="about-one_image">
                                <img src="assets/images/resource/benifits.png" alt="" />
                            </div>
                            <div class="about-one_tomato">
                                <img src="assets/images/resource/good_2.png" alt="" />
                            </div>
                            <div class="about-one_leaf">
                                <img src="assets/images/resource/good_3.png" alt="" />
                            </div>
                            <div class="about-one_counter">
                                <div class="about-one_count"><span class="odometer"
                                        data-count="25"></span><sub>+</sub><i>Years Experiance</i></div>
                            </div>
                        </div>
                    </div>
