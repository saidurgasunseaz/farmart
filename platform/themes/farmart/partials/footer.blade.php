			...
			<div class="auto-container">
									...
									<div class="footer_column col-lg-6 col-md-6 col-sm-12">
										<div class="footer-widget footer-two_logo-widget">
											<div class="footer-logo">
												<a href="{{url('/')}}">
													<img src="{{asset('assets/images/f-logo.png')}}" alt="" title="">
												</a>
											</div>
									...
									<div class="footer_column col-lg-6 col-md-6 col-sm-12">
										<div class="footer-widget contact-widget">
											...
											<ul class="footer-contact_list">
												<li><span
														class="icon fas fa-map-marker-alt fa-fw"></span>5-106/SY227AA1,
												...
												<li><span class="icon fas fa-phone fa-fw"></span>+91 909-070-7085
													(WhatsApp)</li>
												<li><span
														class="icon fas fa-envelope fa-fw"></span>tetraelements@gmail.com
												</li>
											</ul>
											<!-- Social Box -->
				...
				<div class="footer-bottom">
					...
					<div class="main-footer_copyright text-center">
						Copyright 2025. Designed by <a href="https://sunseaz.com/" target="_blank"
							class="foot-bottom">Sunseaz Technologies Pvt Ltd.</a>
					</div>
				</div>
			</div>
		</footer>
