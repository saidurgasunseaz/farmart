        ...
        <div class="wishlist-button product-wishlist-button product-loop_button">
            ...
            >
                <div class="wishlist-icons product-loop_icon">
                    <span class="svg-icon">
                        <i class="fa-regular fa-heart button1"
        style="@if (!empty($wishlistIds) && in_array($product->id, $wishlistIds)) display:none; @endif">
    </i>
                        <!-- <svg>
                            <use
                    ...
                    <span class="svg-icon">
                        <button type="button" class="quick-view-btn button2">
   <i class="fa-solid fa-heart button2"
        style="@if (empty($wishlistIds) || !in_array($product->id, $wishlistIds)) display:none; @endif">
    </i>
